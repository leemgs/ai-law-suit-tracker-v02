...
def find_or_create_issue(owner: str, repo: str, token: str, title: str, label: str) -> int:
    ...
    payload = {
        ...
        "body": (
            ...
            "| NOS 코드 | 의미 | 분류체계 |\n"
            "|:---:|---|---|\n"
            "| **820** | Copyright (저작권 사건) | Nature of Suit |\n"
            "| **3820** | Copyright Appeal (저작권 항소) | Nature of Suit (Appeal) |\n"
            "| **17:101** | Copyright Infringement | Cause of Action |\n"
            "| **17:501** | Copyright Infringement | Cause of Action |\n"
            "| **17:504** | Copyright Infringement | Cause of Action |\n"
            "| **17:505** | Copyright Infringement | Cause of Action |\n"
            "| **17:512** | Copyright Infringement (DMCA) | Cause of Action |\n"
            "| **17:1201** | Copyright Infringement (DMCA) | Cause of Action |\n"
            "| **17:1202** | Copyright Infringement (DMCA) | Cause of Action |\n"
            "| **830** | Patent (특허) | Nature of Suit |\n"
            "| **840** | Trademark (상표) | Nature of Suit |\n"
            "| **190** | Contract: Other (기타 계약 분쟁) | Nature of Suit |\n"
            "| **410** | Antitrust (독점금지법) | Nature of Suit |\n"
            "| **442** | Civil Rights: Employment (고용 관련 시민권) | Nature of Suit |\n"
            "| **360** | Personal Injury: Other | Nature of Suit |\n\n"
            "---\n\n"
